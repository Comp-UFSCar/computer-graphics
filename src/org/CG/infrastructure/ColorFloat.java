...
import org.CG.util.MathHelper;

/**
 * Represents an immutable RGBA color on the [0, 1] spectrum
 *
 * @author Diorge-Mephy
 */
public final class ColorFloat {
    ...
    /**
     * Instantiates a new color by adjusting the brightness of this color
     * This is done by simply adding the given value to the three color components
